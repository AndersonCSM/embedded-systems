...
void setup()
{
  ...
  TCCR2A = 0b00000000; // TC0 (normal operating)
  TCCR2B = 0b00000010; // TC2 with prescaler 8. Overflow every 128us = 256/(16Mhz/8)
  TIMSK2 = (1 << TOIE2); // Enabling interrupt TC0 escreve 1 quando tem interrupção
